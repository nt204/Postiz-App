...
exports.minifyPostsList = minifyPostsList;
exports.expandPostsList = expandPostsList;
exports.minifyPosts = minifyPosts;
exports.expandPosts = expandPosts;
...
function minifyPostItem(post) {
    return mapKeys({
        ...
        integration: post.integration
            ...
            : post.integration,
        tags: post.tags?.map((tagWrapper) => mapKeys({
            ...tagWrapper,
            tag: tagWrapper.tag
...
function minifyPostsList(data) {
    return mapKeys({
        ...data,
        posts: data.posts.map(minifyPostItem),
    }, POST_LIST_KEYS);
}
function expandPostsList(data) {
...
function minifyPosts(data) {
    return mapKeys({
        ...data,
        posts: data.posts.map(minifyPostItem),
    }, POST_CALENDAR_KEYS);
}
function expandPosts(data) {
